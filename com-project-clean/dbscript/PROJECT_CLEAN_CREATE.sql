...
CREATE TABLE "TBL_ADMIN" (
 ...
 "ADMIN_PWD" NVARCHAR2(255) NOT NULL,
...
CREATE TABLE TBL_ADMIN_IP_ADRESS (
  ADMIN_IP_ADRESS_NO NUMBER CONSTRAINT NN_ADMIN_IP_ADRESS_NO NOT NULL
...
ALTER TABLE "TBL_ADMIN_IP_ADRESS" ADD CONSTRAINT "PK_TBL_ADMIN_IP_ADRESS" PRIMARY KEY (
 "ADMIN_IP_ADRESS_NO"
);
