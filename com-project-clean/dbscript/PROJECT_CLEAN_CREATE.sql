DROP TABLE "TBL_VACATION_COMMIT" CASCADE CONSTRAINTS;
DROP TABLE TBL_REASON CASCADE CONSTRAINTS;
DROP TABLE TBL_ADMIN_IP_ADRESS CASCADE CONSTRAINTS;
DROP TABLE "TBL_NOTIFICATION" CASCADE CONSTRAINTS;
DROP TABLE "TBL_EMPLOYEE_PAY" CASCADE CONSTRAINTS;
DROP TABLE "TBL_VACATION" CASCADE CONSTRAINTS;
DROP TABLE "TBL_SURCHARGE" CASCADE CONSTRAINTS;
DROP TABLE "TBL_BOOKMARK" CASCADE CONSTRAINTS;
DROP TABLE "TBL_ADMIN_PICTURE" CASCADE CONSTRAINTS;
DROP TABLE TBL_CHECKLIST CASCADE CONSTRAINTS;
DROP TABLE TBL_APPLY_EMPLOYEE CASCADE CONSTRAINTS;
DROP TABLE "TBL_ADMIN_ADDRESS" CASCADE CONSTRAINTS;
DROP TABLE "TBL_ADMIN_EMAIL" CASCADE CONSTRAINTS;
DROP TABLE "TBL_ADMIN_PAY" CASCADE CONSTRAINTS;
DROP TABLE "TBL_SUPPLEMENT_SERVICE" CASCADE CONSTRAINTS;
DROP TABLE "TBL_RETIRE_ADMIN" CASCADE CONSTRAINTS;
DROP TABLE "TBL_RETIRE_EMPLOYEE" CASCADE CONSTRAINTS;
DROP TABLE TBL_ADMIN_MEMBER_ROLE CASCADE CONSTRAINTS;
...
DROP TABLE "TBL_BEST_EMPLOYEE_PAY" CASCADE CONSTRAINTS;
-----------------------------------------------
...
DROP SEQUENCE SEQ_TBL_REST_COMMIT;
DROP SEQUENCE SEQ_TBL_ADMIN_PICTURE;
DROP SEQUENCE SEQ_TBL_BEST_EMPLOYEE_PAY;
...
CREATE SEQUENCE SEQ_TBL_BEST_EMPLOYEE_PAY NOCACHE;
CREATE SEQUENCE SEQ_TBL_RETIRE_EMPLOYEE NOCACHE START WITH 1;
...
, CONSTRAINT CK_CHECK_STATUS CHECK (CHECK_STATUS IN ('N', 'R', 'A', 'D', 'E', 'B'))
);
...
CREATE TABLE "TBL_BEST_EMPLOYEE_PAY" (
 "BEST_EMPLOYEE_PAY_HISTORY_NO" NUMBER NOT NULL,
 "BEST_EMPLOYEE_PAY_DATE" DATE NOT NULL,
 "BEST_EMPLOYEE_NO" NUMBER NOT NULL,
 "BEST_EMPLOYEE_BONUS" NUMBER NOT NULL
);

COMMENT ON COLUMN "TBL_BEST_EMPLOYEE_PAY"."BEST_EMPLOYEE_PAY_HISTORY_NO" IS '우수사원 보너스 내역 번호';
COMMENT ON COLUMN "TBL_BEST_EMPLOYEE_PAY"."BEST_EMPLOYEE_PAY_DATE" IS '우수사원 보너스 지급일';
COMMENT ON COLUMN "TBL_BEST_EMPLOYEE_PAY"."BEST_EMPLOYEE_NO" IS '우수사원';
COMMENT ON COLUMN "TBL_BEST_EMPLOYEE_PAY"."BEST_EMPLOYEE_BONUS" IS '우수사원 보너스 급여';
...
ALTER TABLE "TBL_BEST_EMPLOYEE_PAY" ADD CONSTRAINT "PK_TBL_BEST_EMPLOYEE_PAY" PRIMARY KEY (
...
ALTER TABLE "TBL_BEST_EMPLOYEE_PAY" ADD CONSTRAINT "FK_TBL_BEST_EMPLOYEE_PAY_TO_TBL_EMPLOYEE" FOREIGN KEY (
	"BEST_EMPLOYEE_NO"
)
