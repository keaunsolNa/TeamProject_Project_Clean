...
CREATE TABLE "TBL_EMPLOYEE_ADDRESS" (
 "EMPLOYEE_NO" NUMBER NOT NULL,
 "EMPLOYEE_ADDRESS_NO" VARCHAR2(10) NOT NULL,
...
CREATE TABLE "TBL_ADMIN_ADDRESS" (
 "ADMIN_NO" NUMBER NOT NULL,
 "ADMIN_ADDRESS_NO" VARCHAR2(10) NOT NULL,
...
, CONSTRAINT CK_CHECK_STATUS CHECK (CHECK_STATUS IN ('N', 'R', 'A', 'D'))
);
...
COMMENT ON COLUMN "TBL_VACATION_COMMIT"."CONFIRM_NO" IS '관리자번호';
...
COMMENT ON COLUMN "TBL_EMPLOYEE_REST_COMMIT"."CONFIRM_NO" IS '결재번호';
COMMENT ON COLUMN "TBL_EMPLOYEE_REST_COMMIT"."RETURN_REASON" IS '사유';
COMMENT ON COLUMN "TBL_EMPLOYEE_REST_COMMIT"."EMPLOYEE_LAST_CONFIRM_DATE" IS '결재날짜';
