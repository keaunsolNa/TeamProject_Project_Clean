 ...
 * org.springframework.http.server.ServerHttpResponse; import
 ...
 * servletRequest = (ServletServerHttpRequest) request; HttpSession session =
 * servletRequest.getServletRequest().getSession(); attributes.put(SESSION,
 * session); } return true; }
 * 
