...
public class AdminVacationDTO implements Serializable {

	private static final long serialVersionUID = 7124015900894600748L;
	...
	public AdminVacationDTO() {
	}



	public AdminVacationDTO(int adminNo, String adminName, String adminId, String adminPwd, Date adminBirth,
			...
			String adminPictureThumbnailName, List<VacationDTO> vacationList) {
	...
	public void setVacationList(List<VacationDTO> vacationList) {
		this.vacationList = vacationList;
	}
	...
	public String toString() {
		return "AdminVacationDTO [adminNo=" + adminNo + ", adminName=" + adminName + ", adminId=" + adminId
