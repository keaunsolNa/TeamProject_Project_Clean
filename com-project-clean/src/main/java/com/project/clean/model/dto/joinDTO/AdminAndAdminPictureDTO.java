...
public class AdminAndAdminPictureDTO implements Serializable{
	private static final long serialVersionUID = -8465550164635410387L;
	...
	private List<AdminPictureDTO> adminPicture;

	
	
	public AdminAndAdminPictureDTO() {
	}


	

	public AdminAndAdminPictureDTO(int adminNo, String adminName, String adminId, String adminPwd, Date adminBirth,
			...
			List<AdminPictureDTO> adminPicture) {
	...
	public List<AdminPictureDTO> getAdminPicture() {
		return adminPicture;
	}
	...
	public void setAdminPicture(List<AdminPictureDTO> adminPicture) {
		this.adminPicture = adminPicture;
	}
	...
	public String toString() {
		return "AdminAndAdminPictureDTO [adminNo=" + adminNo + ", adminName=" + adminName + ", adminId=" + adminId
				...
				+ ", adminUseAnnualVacation=" + adminUseAnnualVacation + ", adminPicture=" + adminPicture + "]";
	}
